...
namespace RobotKit
{
    public class Robot
    {
        ...
        private RfcommDeviceService _info = null;
        ...
        internal Robot(RfcommDeviceService info)
        {
            _info = info;
			_btname = info.Device.Name;
			//_btname = info.Name;
		}
        ...
        {
            Boolean flag;
			Debug.WriteLine(String.Concat("Connecting: ", _info.Device.Name));
			try
            {
            ...
            {
				Exception exception = exception1; Debug.WriteLine(String.Concat("Exception looking up service ", _info.Device.Name, " ", exception.Message));
                flag = false;
                return flag;
            }
        ...
        {
			Object[] connectionServiceName = new Object[] { "[Robot ", _btname, " @ ", _info.ConnectionHostName, " ", _connectionState, "]" };
